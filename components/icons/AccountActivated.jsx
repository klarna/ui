...
const AccountActivated = (hexColor, props) => (
  <Icon stroke={hexColor} strokeWidth='2' strokeLinecap='round' {...props}>
    <g fill={hexColor} stroke='none' transform='translate(28, 14)'>
      <path
...
export default icon(AccountActivated)
