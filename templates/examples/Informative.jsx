  ...
  variations: [
    {
      ...
      example: React.createElement(lekplats(LandingExample.options)(LandingExample))
    },

    {
      ...
      example: React.createElement(lekplats(ExplanationExample.options)(ExplanationExample))
    },
    //
    // {
    //   title: 'Landing',
